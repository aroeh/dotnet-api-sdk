...
namespace Dotnet.API.Example.Middleware;

public class CustomExceptionHandler : IExceptionHandler
{
    private readonly ILogger<CustomExceptionHandler> logger;

    public CustomExceptionHandler(IHostEnvironment env, ILoggerFactory logFactory)
    {
        ...
        logger = logFactory.CreateLogger<CustomExceptionHandler>();
    }

    public async ValueTask<bool> TryHandleAsync(HttpContext httpContext, Exception exception, CancellationToken cancellationToken)
    {
        logger.LogError(exception, exception.Message, new { TraceId = httpContext.TraceIdentifier });
    ...
    private static ProblemDetails SetProblemDetails(HttpContext httpContext, Exception exception)
    {
        ...
        problemDetails.Extensions["custom"] = "Custom API Exception Handler";
